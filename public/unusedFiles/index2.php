    ...
    <![endif]-->
        ...
        <div class="container-fluid">
            <div class="row">
                ...
                <!-- Middle content area -->
                <div class="col-sm-8 content-area bg-white pt-3">
                    <div class="top-bar mb-3">
                        <div class="row">
                            <div class="col-sm-10">
                                <h2>All product list</h2>
                            </div>
                            <div class="col-sm-2 pt-3"><i
                                    class="fas fa-cart-plus d-flex justify-content-end"><sup>4</sup>
                                </i>
                            </div>
                        </div>
                    </div>
                    <div class="row cart-items">
                        <div class="col-sm-3 mb-3">
                            <div class="card" style="width:  rem;">
                                ...
                                <img src="img/product_images/camera.jpg" class="card-img-top img-fluid"
                                    alt="Product Image">
                                <div class="card-body">
                                    ...
                                    <a href="#" class="btn btn-sm btn-primary">Add <i class="fas fa-cart-plus"></i></a>
                        ...
                        <div class="col-sm-3 mb-3">
                            <div class="card" style="width:  rem;">
                                ...
                                <img src="img/product_images/cell-phone.jpg" class="card-img-top img-fluid"
                                    alt="Product Image">
                                <div class="card-body">
                                    <h5 class="card-title">Description</h5>
                                    <p class="card-text">Some quick example text to build on the card...</p>
                        ...
                        <div class="col-sm-3 mb-3">
                            <div class="card" style="width:  rem;">
                                ...
                                <img src="img/product_images/laptop.jpg" class="card-img-top img-fluid"
                                    alt="Product Image">
                                <div class="card-body">
                                    <h5 class="card-title">Description</h5>
                                    <p class="card-text">Some quick example text to build on the card...</p>
                        ...
                        <div class="col-sm-3 mb-3">
                            <div class="card" style="width:  rem;">
                                ...
                                <img src="img/product_images/watch.jpg" class="card-img-top img-fluid"
                                    alt="Product Image">
                                <div class="card-body">
                                    <h5 class="card-title">Description</h5>
                                    <p class="card-text">Some quick example text to build on the card...</p>
                        ...
                        <div class="col-sm-3 mb-3">
                            <div class="card" style="width:  rem;">
                                <img src="img/product_images/shirt.jpg" class="card-img-top img-fluid"
                                    alt="Product Image">
                                <div class="card-body">
                                    <h5 class="card-title">Description</h5>
                                    <p class="card-text">Some quick example text to build on the card...</p>
                        ...
                        <div class="col-sm-3 mb-3">
                            <div class="card" style="width:  rem;">
                                ...
                                <img src="img/product_images/tv.jpg" class="card-img-top img-fluid" alt="Product Image">
                                <div class="card-body">
                                    <h5 class="card-title">Description</h5>
                                    <p class="card-text">Some quick example text to build on the card...</p>
                                    <s>Product: 5200.00 &#2547;</s>
