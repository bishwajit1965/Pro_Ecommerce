    ...
    <div class="container bg-white ">
        <div class="row pt-3 pb-3">
            <div class="col-sm-6 image-cover-left">
                <img class="img-fluid img-responsive" style="width:100%;height:430px;border-radius: 5px;" src="../img/background/sunRise2.jpg" alt="">
            </div>
            <div class="col-sm-6 form-input-area">
                ...
                <form action="processCustomerProfile.php" method="post">
                    ...
                    <div class=" register-link">
                        ...
                        <button type="submit" name="submit" value="register" class="btn btn-sm btn-info"><i class="fas fa-users">
                            </i> Register</button>
