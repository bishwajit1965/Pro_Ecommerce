                    ...
                    <div class="col-sm-10">
                        ...
                        <div class="row">
                                ...
                                <div class="card" style="">
                                    ...
                                    <div class="card-body p-1 pt-3 pb-2">
                                        ...
                                        <div class="btn-group cart-add-link" role="group" aria-label="Basic example">
                                            <a href="single.php?single_id=<?php echo $displayAllData->pro_id; ?>"
                                                class="btn btn-primary btn-sm"><i class="fas fa-info-circle"></i>
                                                Add</a>

                                            <a href="single.php?single_id=<?php echo $displayAllData->pro_id; ?>"
                                                class="btn btn-warning btn-sm"><i class="fas fa-info-circle"></i>
                                                Details</a>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="col-sm-3 p-1 products-data">
                                <div class="card" style="">
                                    <img src="../../admin/ecommerce/<?= isset($categoryProduct->photo) ? $categoryProduct->photo : ''; ?>"
                                        class="card-img-top cart-img img-cover" alt="Cart Image">
                                    <div class="card-body p-1 pt-3 pb-2">
                                        <h6 class="card-title">
                                        ...
                                        <div class="btn-group cart-add-link" role="group" aria-label="Basic example">
                                            <a href="single.php?single_id=<?php echo $categoryProduct->pro_id; ?>"
                                                class="btn btn-primary btn-sm"> <i class="fas fa-info-circle"></i>
                                                Add</a>
                            ...
                            <div class="col-sm-3 p-1 products-data">
                                <div class="card" style="">
                                    <img src="../../admin/ecommerce/<?= isset($subCategoryProduct->photo) ? $subCategoryProduct->photo : ''; ?>"
                                        class="card-img-top cart-img img-cover" alt="Cart Image">
                                    <div class="card-body p-1 pt-3 pb-2">
                                        <h6 class="card-title">
                                        ...
                                        <?php } ?>
                                        <div class="btn-group cart-add-link" role="group" aria-label="Basic example">
                                            <a href="single.php?single_id=<?php echo $subCategoryProduct->pro_id; ?>"
                                                class="btn btn-primary btn-sm"><i class="fas fa-info-circle"></i>
                                                Add</a>
                            ...
                            <div class="col-sm-3 p-1 products-data">
                                <div class="card" style="">
                                    ...
                                    <div class="card-body p-1 pt-3 pb-2">
                                        ...
                                        <span style="font-weight:bold; display:block;">Price :
                                            <?= isset($product->present_price) ? number_format($product->present_price, 2, '.', '') : ''; ?><b>&#2547;</b>
                                        </span>
                                        <span style="font-weight:bold; display:block;">Brand :
                                            <?php
                                                            $brandName = $brand->getBrand($tableBrand);
                        ...
                        <div class="panel">
                            <div class="row brands">
                                <ul>
                                    ...
                                    <li>
                                        <a
                                            href="brandCategorySubCategory.php?sub_category_id=<?= $subCategory->sub_cat_id; ?>">
