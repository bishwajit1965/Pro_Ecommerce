                    ...
                    <div class="table-responsive-sm">
                        <table class="table table-condensed table-sm table-striped mb-0">
                                            ...
                                            <div class="col-sm-7">
                                                <div class="row d-dlex flex-row justify-content-around" style="padding-top:35px;">
                                                    ...
                                                    if (!empty($cartData)) {
                                                        ...
                                                        <form action="processCart.php" method="post">
                                                            <input type="hidden" name="action" value="verify">
                                                            <button type="submit" name="submit" value="order" class="btn btn-sm btn-danger"><i class="fas fa-folder-plus"></i>
                                                                Order now</button>
                                                        </form>
                                                        <form action="cart.php" method="post">
                                                            <button type="submit" name="submit" class="btn btn-sm btn-info"><i class="fas fa-cart-plus">
                                                                </i>
                                                                Cart </button>
                                                        </form>
                                                    <?php
                                                    } else {
                                                        echo "<span style='font-size:18px;color:red;font-weight:700;'>Cart is Empty !!!</span>";
                                                    }
                                                    ?>
                            ...
                            <tfoot class="thead-inverse">
                                <tr>
                                    <th colspan="7" class="text-center py-2"></th>
                                </tr>
                            </tfoot>
                        </table>
                    </div>
