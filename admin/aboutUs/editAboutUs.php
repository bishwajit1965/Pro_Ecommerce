            ...
            <div class="box">
                ...
                <div class="box-body">
                    ...
                    <div class="col-sm-10 col-sm-offset-1">
                        ...
                        $result = $aboutUs->updateView($id, $tableAboutUs);
                        ?>
                        ...
                        <form action="processAboutUs.php" method="post">
                            ...
                            <button type="submit" name="submit" value="update_about_us" class="btn btn-sm btn-primary">
                                <i class="fa fa-upload"></i> Update about us data</button>
