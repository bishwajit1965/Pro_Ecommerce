                ...
                <div class="box-body">
                    ...
                    <div class="col-sm-8 col-sm-offset-2">
                        ...
                        if (isset($_GET['edit_id'])) {
                            $id = $_GET['edit_id'];
                            $result = $header->updateView($id, $tableSocialMedia);
                        }
                        ...
                        <form action="processSocialMedia.php" method="post" enctype="multipart/form-data">
                            ...
                            if ($_SESSION['userEmail'] == $user_home->getEmail()) {
                                ...
                                <button type="submit" name="submit" value="update" class="btn btn-sm btn-primary"><i class="fa fa-edit"></i> Update</button>
