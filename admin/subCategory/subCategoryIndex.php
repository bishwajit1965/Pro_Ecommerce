...
<div class="wrapper">
    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <h1>Sub subCategory index page<small>it all starts here</small></h1>
            <ol class="breadcrumb">
        ...
        <section class="content">
            ...
            <div class="box">
                <div class="box-header with-border">
                    <h3 class="box-title"><a class="btn btn-sm btn-primary" href="addSubCategory.php">
                            <i class="fa fa-plus"></i> Add sub subCategory data</a> <span class="label label-success">
                            Sub Categories </span><sup><span class="label label-danger"><?php echo $subCategory->numberOfRows($table);?></sup>
                        </span>
                    </h3>
                ...
                <div class="box-body">
                    ...
                    if (isset($_GET['delete_id'])) {
                        $id = $_GET['delete_id'];
                        $dataDestroyed = $subCategory->destroy($id, $table);
                        if ($dataDestroyed) {
                    ...
                    <table id="example1" class="table table-bordered table-striped table-small">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <?php echo $result->sub_cat_name; ?>
                                </td>
                                <td>
                                    <?php echo $result->sub_cat_id; ?>
                                </td>
                                <td>
                                ...
                                <td>
                                    ...
                                    <a class="btn btn-xs btn-primary" data-toggle="tooltip" title="Edit Product!"
                                        href="editSubCategory.php?edit_id=<?php echo $result->sub_cat_id; ?>"><i
                                            class="fa fa-pencil"></i> Edit</a>

                                    <a class="btn btn-xs btn-danger"
                                        href="subCategoryIndex.php?delete_id=<?php echo $result->sub_cat_id; ?>"
                                        onClick="return confirm('Do you really want to delete this data? If deleted it is lost for ever !!!');">
                                        <i class="fa fa-trash"></i> Delete</a>

                                    <a class="btn btn-xs btn-danger"
                                        href="deleteSubCategory.php?delete_id=<?php echo $result->sub_cat_id; ?>">
                                        <i class="fa fa-trash"></i> View & Delete</a>
                                        <?php
                                    } else {
                                        ?>
                                    <a class="btn btn-xs btn-primary"
                                        href="editSubCategopry.php?edit_id=<?php echo $result->sub_cat_id; ?>"><i
