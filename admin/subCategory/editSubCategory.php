                ...
                <div class="box-body">
                    ...
                    <div class="col-sm-6 col-sm-offset-3">
                        ...
                        if (isset($_GET['edit_id'])) {
                            $id = $_GET['edit_id'];
                            $result = $subCategory->updateView($id, $table);
                        }
                        ...
                        <form action="ProcessSubCategory.php" method="post">
                            <input type="hidden" name="sub_cat_id" class="form-control"
                                value="<?php echo $result->sub_cat_id; ?>">

                            <div class="form-group">
                                <label for="name">Sub Category Name:</label>
                                <input type="text" name="sub_cat_name" class="form-control" class="form-control"
                                    value="<?php echo isset($result->sub_cat_name) ? $result->sub_cat_name : '' ; ?>">
                            </div>
                            <div class="form-group">
                                <label for="cat_id">Category Id:</label>
                                <select id="select" name="cat_id" class="form-control">
                                        <?php
                                        $categoryData = $category->index($table2);
                            ...
                            if ($_SESSION['userEmail'] == $user_home->getEmail()) {
                                ...
                                <a href="subCategoryIndex.php" class="btn btn-sm btn-warning">
                                    <i class="fa fa-fast-backward"></i> SuCb Category Index</a>
                                <?php
                            } else {
                                ?>
                                <a href="subCategoryIndex.php" class="btn btn-sm btn-warning">
