...
class SubCategory
{
    ...
    {
        try {
            $sql = "SELECT * FROM $table WHERE sub_cat_id = :edit_id";
            $stmt = $this->conn->prepare($sql);
    ...
    {
        try {
            $sql = "SELECT * FROM $table WHERE sub_cat_id = :delete_id";
            $stmt = $this->conn->prepare($sql);
    ...
    {
        try {
            $sql = "DELETE FROM $table WHERE sub_cat_id = :id";
            $stmt = $this->conn->prepare($sql);
